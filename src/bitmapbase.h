...
public:
    ...
    virtual void drawGradientOval(const Point& center, double radiusX, double radiusY, const RGB& c, const RGB& c2, int m) = 0;
    virtual void drawDiamond(const Point& center, double width, double height, const RGB& c, int m) = 0;
